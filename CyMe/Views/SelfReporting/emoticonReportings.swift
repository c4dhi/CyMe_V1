                ...
                ForEach(emoticons, id: \.0) { (emoticon, description) in
                    VStack {
                        Button(action: {
                            ...
                            selectedOption = SymptomSelfReportModel(healthDataTitle: setting.title, questionType: setting.questionType, reportedValue: description)
                        }) {
                            Text(emoticon)
                                .font(.title2)
                                .padding()
...
struct AmountOfHourQuestionView: View {
    ...
    private func updateSelectedOption() {
        ...
        selectedOption = SymptomSelfReportModel(healthDataTitle: setting.title, questionType: setting.questionType, reportedValue: reportedValue)
    }
}
